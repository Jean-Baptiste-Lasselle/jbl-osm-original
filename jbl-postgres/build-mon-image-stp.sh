...
# NOM_DE_MON_IMAGE="$DISTRIBUTED_PRODUCT_DISTRIBUTION_NAME-$POSTGRESQL_VERSION_ID-$UNEDERLYING_CONTAINER_OS_IMAGE:$DISTRIBUTED_PRODUCT_VERSION_ID"

export DOCKER_BUILD_ARGS=""
export DOCKER_BUILD_ARGS="$BUILD_ARGS --build-arg POSTGRES_USER=$POSTGRES_USER"
export DOCKER_BUILD_ARGS="$BUILD_ARGS --build-arg POSTGRES_PASSWORD=$POSTGRES_PASSWORD"
export DOCKER_BUILD_CONTEXT=.
sudo docker build -t $NOM_DE_MON_IMAGE $DOCKER_BUILD_ARGS $DOCKER_BUILD_CONTEXT
