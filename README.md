...
![Mikael Leroy (screencshot commentaire "very informative")](https://github.com/Jean-Baptiste-Lasselle/jbl-osm-original/raw/master/issues-memory/michael_leroy_daddies_pof_advice.png)
 ...
 _Michael, what is really very informative in your former company's blog? If that was your Boss from "shine solution" who forced you posting that comment, next time, tell your boss to comment with his name, not yours, or explain him it has no added value to write quick stupid things, it will end up with an article like that on github. And Mikael, next you consider accepting your namle mentionned as author of something stupid in English, please consider as well we have an image in other countries, as French Professionals: Don't we have a duty to stand up for it? Let's not have people think that French engineers are just stupid guys that write anything you ask them to, regardless from how stupid that may be?
 Later addedum : 
 I want to admit I reacted very strngly in the midst of my work repairing all the mess in the docker-compose git repo referenced in shinesolutions.com 's blog. What made my reaction strong, is that, when we professional look up the internet, we spend a lot of time analyzing information we read, and files we dowload. That finished, you end up understanding what happened is a company pushed employees to post articles, wiht github repo attached, that they just wanted a post on the internet, not caring one second if anything made any sense in the posted content. In other words, I was lucky I ended up with anything at all, had to work 12 days repairing all this, everyday stripping one more piece out, and completely redsigning another. So I pay the price of a company needs. Actually, I was lucky that time, because you will learn, in the next month, that my hard work gave me something valuable back. Anyway, Okay, but I think it is a very bad idea from that example company (I'm sure they're not alone in the world doing that) to do that:
 ...
 * 2 years of exposal of that content, plus the gtihub repo? What if a big, important customer, has a really god devops, even better than me, inhouse. And what if that devops takes a look at that? Can you imagine what he, is going to say, to his boss, about that example company? I'd personnaly think of that as very dangerous for my company.
 Anyway, I wapologize to Mike Leroy, for being I admit, really harsh. too harsh. 
 _
